...
/**
 * WaTor Rules; generate the rule that determines if the randomly number we generated is enough to
 * deem if our cell will move or stay the same
 */
public class WaTorRules extends CellSocietyRules {
   ...
   */
  public WaTorRules(String type, Map<String, String> parameters) {
