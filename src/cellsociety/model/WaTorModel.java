 ...
 * the WaTor game for CellSociety. It overrides the abstract setNextState()
 * method within the abstract class to set up the next state of a cell as a result
 * of applied WaTor-specific rules.
 */
public class WaTorModel extends CellSocietyModel{
    ...
    /**
     * The constructor for the WaTor Model. It takes in the same variables
     ...
     *                  the max reproduction required for cells to reproduce, as well as the starting
     *                  energy levels for Shark cells.
     ...
     * CellSocietyModel class. It moves the Fish and Shark cells to open spots (empty cells
     * for fish and empty or fish cells for sharks). It also uses the WaTorMovement class
     * to move these cells as well as keep track of the reproduction and energy
     * stages each relevant cell is at. Empty cells are not changed unless a shark
     * or fish cell moves into them.
