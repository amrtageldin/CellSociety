...
/**
 * General 'Rule' class, we want this to hold the information that essentially says
 * "if a condition is met based off a comparator, give a condition result"
 */
abstract public class Rule {
  ...
  protected int getMyComparator(){ return myComparator;}

  protected Integer getMyConditionIsMetResult(){ return myConditionIsMetResult;}
