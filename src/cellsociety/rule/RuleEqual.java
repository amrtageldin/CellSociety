...
/**
 * The general rule class that will be used for equality comparisons; if we have a number that needs
 * to be exactly equal to another number this class is used
 */
